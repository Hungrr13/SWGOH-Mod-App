...
import { useThemeControls } from '../theme/appTheme';
...
// Light-mode variants whitewash the inner cavity + outer drop-shadow so
// those dark regions don't render as black blobs on a light background.
// Generated by tools/gen-shape-lightmode.py.
const SHAPE_SOURCES_LIGHT = {
  Square:   require('../../assets/shapes/square-light.png'),
  Arrow:    require('../../assets/shapes/arrow-light.png'),
  Diamond:  require('../../assets/shapes/diamond-light.png'),
  Triangle: require('../../assets/shapes/triangle-light.png'),
  Circle:   require('../../assets/shapes/circle-light.png'),
  Cross:    require('../../assets/shapes/cross-light.png'),
};
...
export default function ModShapeIcon({ shape, size = 22 }) {
  ...
  const sources = isDark ? SHAPE_SOURCES_DARK : SHAPE_SOURCES_LIGHT;
